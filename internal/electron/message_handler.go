...
type MessageHandler interface {
	...
	Handle(in json.RawMessage) (interface{}, error)
}
...
type MessageListener interface {
	...
	Handle(w *astilectron.Window, message MessageIn) (interface{}, error)
...
func (m *DefaultMessageListener) Handle(_ *astilectron.Window, message MessageIn) (interface{}, error) {
	m.mu.RLock()
	defer m.mu.RUnlock()
	...
	p, err := h.Handle(message.Payload)
	if err != nil {
...
func handleMessage(w *astilectron.Window, listener MessageListener, logger astikit.SeverityLogger) astilectron.ListenerMessage {
